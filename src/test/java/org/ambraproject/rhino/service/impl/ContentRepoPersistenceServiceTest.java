...
public class ContentRepoPersistenceServiceTest extends AbstractRhinoTest {
  ...
  public void testCreateArticleItemShouldSucceed() {
    final ImmutableMap<String, ArticleFileInput> expectedFileInputs = ImmutableMap.of(
        "type1", ArticleFileInput.create("file1" /* filename */, mock(RepoObjectInput.class)),
        "type2", ArticleFileInput.create("file2" /* filename */, mock(RepoObjectInput.class)),
        "type3", ArticleFileInput.create("file3" /* filename */, mock(RepoObjectInput.class)),
        "type4", ArticleFileInput.create("file4" /* filename */, mock(RepoObjectInput.class)));
  ...
  public void testPersistAncillaryFilesShouldSucceed() {
    ...
    final ImmutableList<ArticleFileInput> expectedAncillaryFiles = ImmutableList.of(
        ArticleFileInput.create("ancillary1" /* filename */, mock(RepoObjectInput.class)),
        ArticleFileInput.create("ancillary2" /* filename */, mock(RepoObjectInput.class)),
        ArticleFileInput.create("ancillary3" /* filename */, mock(RepoObjectInput.class)),
        ArticleFileInput.create("ancillary4" /* filename */, mock(RepoObjectInput.class)),
        ArticleFileInput.create("ancillary5" /* filename */, mock(RepoObjectInput.class)),
        ArticleFileInput.create("ancillary6" /* filename */, mock(RepoObjectInput.class)));
