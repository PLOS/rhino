...
public class ContentRepoPersistenceServiceTest extends AbstractRhinoTest {
  ...
  public void testCreateArticleItemShouldSucceed() {
    final ImmutableMap<String, ArticleFileInput> expectedFileInputs = ImmutableMap.of(
        "type1", new ArticleFileInput("file1", mock(RepoObjectInput.class)),
        "type2", new ArticleFileInput("file2", mock(RepoObjectInput.class)),
        "type3", new ArticleFileInput("file3", mock(RepoObjectInput.class)),
        "type4", new ArticleFileInput("file4", mock(RepoObjectInput.class)));
  ...
  public void testPersistAncillaryFilesShouldSucceed() {
    ...
    final ImmutableList<ArticleFileInput> expectedAncillaryFiles = ImmutableList.of(
        new ArticleFileInput("ancillary1", mock(RepoObjectInput.class)),
        new ArticleFileInput("ancillary2", mock(RepoObjectInput.class)),
        new ArticleFileInput("ancillary3", mock(RepoObjectInput.class)),
        new ArticleFileInput("ancillary4", mock(RepoObjectInput.class)),
        new ArticleFileInput("ancillary5", mock(RepoObjectInput.class)),
        new ArticleFileInput("ancillary6", mock(RepoObjectInput.class)));
