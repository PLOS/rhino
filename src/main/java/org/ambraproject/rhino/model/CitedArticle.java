 ...
 */
public class CitedArticle extends AmbraEntity {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof CitedArticle)) return false;


    CitedArticle citedArticle = (CitedArticle) o;

    if (getID() != null ? !getID().equals(citedArticle.getID()) : citedArticle.getID() != null) return false;
