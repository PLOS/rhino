...
public class IssueCrudController extends RestController {
  ...
  @RequestMapping(value = "/versioned/issues/{issueDoi}", method = RequestMethod.GET)
  ...
  @Transactional(readOnly = true)
  @RequestMapping(value = "/versioned/journals/{journalKey}/volumes/{volumeDoi}/issues/{issueDoi}", method = RequestMethod.GET)
  ...
  @RequestMapping(value = "/versioned/journals/{journalKey}/volumes/{volumeDoi}/issues/{issueDoi}", method = RequestMethod.PATCH)
  ...
  @Transactional(rollbackFor = {Throwable.class})
  @RequestMapping(value = "/versioned/journals/{journalKey}/volumes/{volumeDoi}/issues/{issueDoi}", method = RequestMethod.DELETE)
